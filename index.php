	...
	<header id="head">
		<div class="container">
             <div class="heading-text">							
							...
							<p>Mendidik dan Belajar Bersama Untuk Menjadi Lebih Baik</p>
						</div>
    ...
    <div class="row">
					...
					<div class="col-md-12">
						<div class="grey-box-icon b4">  
							<h3>WELCOME</h3>
							<p>Selamat datang di situs LES PRIVAT PADA HOME SCHOOLING PRIMAGAMA, segera daftarkan buah hati anda </p>
     						<p><a href="./pendaftaran.php"><em>Daftar →</em></a></p>
						</div><!--grey box -->
					</div><!--/span3-->
				</div>
    </div>
