...
$query = "SELECT * FROM pendaftar WHERE statusdaftar='Diterima'";
...
$jumlah = mysqli_num_rows($result);
   ...
   <div class="header">
    ...
    <p><strong>LAPORAN DATA CALON SISWA DITERIMA HOMESCHOOLING PRIMAGAMA</strong></p>
    <p class="alamat">Jalan Boulevar Selatan, Marga Mulya, Bekasi Utara, Kota Bekasi, Jawa Barat 17141</p>
   	      ...
   	      <table width="100%" align="center" cellspacing="0" cellpadding="2" border="1px" class="style1">
              ...
              <h4 class="header smaller lighter blue">Daftar Calon Siswa Diterima : <?php echo $jumlah;?></h4>
   	          <tr>
