...
$query = "SELECT * FROM pendaftar WHERE statusdaftar='tahap seleksi'";
...
<div class="header">
    ...
    <p><strong>LAPORAN DATA PENDAFTARAN CALON SISWA TAHAP SELEKSI HOMESCHOOLING PRIMAGAMA</strong></p>
    <p class="alamat">Jalan Boulevar Selatan, Marga Mulya, Bekasi Utara, Kota Bekasi, Jawa Barat 17141</p>
</div>

<h4 class="header smaller lighter blue">Daftar Calon Siswa Tahap Seleksi: <?php echo $jumlah; ?></h4>
